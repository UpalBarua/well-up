...
const Success = () => {
  ...
  return (
    <section className="mt-14">
      <h1 className="mb-14 text-2xl font-bold text-center">
        OUR SUCCESS_STORY
      </h1>
      <div className="grid grid-cols-1 gap-8 mt-8 ml-8 lg:grid-cols-2">
          ...
          <div key={success?.id}>
            <div>
              <iframe
                ...
                allowFullScreen
                className="shadow-xl  shadow-blue-300"></iframe>
            </div>
          </div>
        ))}
      </div>
          ...
          {textReviews?.map((reviews) => (
            <div key={reviews?.id}>
              <div
                ...
                className="flex flex-col mx-4 my-6 max-w-sm shadow-lg">
                ...
                <div className="flex flex-col justify-center items-center p-8 rounded-b-lg dark:bg-violet-400 dark:text-gray-900">
                  <img
                    src={reviews?.image}
                    alt=""
